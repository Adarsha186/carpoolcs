...
const Customer = () => {
  ...
  const submitHandler = (event) => {
    ...
    axios
      .post(customerUrl, requestBody, requestConfig)
      .then((response) => {
  ...
  const bookHandler = (row) => {
    ...
    axios
      .patch(customerUrl, requestBody, requestConfig)
      .then((response) => {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-center">
        <div className="w-full max-w-md space-y-8 p-4 bg-indigo-100 bg-opacity-80">
          <div>
