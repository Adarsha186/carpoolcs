...
const driverUrl =
  "https://np9i32r1u6.execute-api.eu-west-1.amazonaws.com/dev/driver_details";
  ...
  const Driver = () => {
    ...
    const submitHandler = (event) => {
      ...
      axios
        .post(driverUrl, requestBody, requestConfig)
        .then((response) => {
    ...
    return (
      <div className="flex min-h-full items-center justify-center px-4 py-12 sm:px-6 lg:px-8 bg-indigo-100">
        <div className="w-full max-w-md space-y-8 bg-white p-8 rounded-md shadow-md">
          ...
          <div className="-space-y-px rounded-md shadow-sm">
            <div>
              <label htmlFor="carNo" className="sr-only">
                Car No.
              </label>
              <input
                id="carNo"
            ...
            <div>
              <label htmlFor="driverLicenseNo" className="sr-only">
                Driver License No.
              </label>
              <input
                id="driverLicenseNo"
            ...
            <div>
              <label htmlFor="driverName" className="sr-only">
                Driver Name
              </label>
              <input
                id="driverName"
            ...
            <div>
              <label htmlFor="driveFrom" className="sr-only">
                Drive From
              </label>
              <input
                id="driveFrom"
            ...
            <div>
              <label htmlFor="driveTo" className="sr-only">
                Drive To
              </label>
              <input
                id="driveTo"
            ...
            <div>
              <label htmlFor="driveStartTime" className="sr-only">
                Drive Start Time
              </label>
              <input
                id="driveStartTime"
            ...
            <div>
              <label htmlFor="noSeats" className="sr-only">
                Number of seats
              </label>
              <input
                id="noSeats"
          ...
          <button
              type="submit"
              className="group relative flex w-full justify-center rounded-md bg-black px-3 py-2 text-sm font-semibold text-white hover:bg-gray-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-800"
            >
              Add Your Car
            </button>
          </div>
